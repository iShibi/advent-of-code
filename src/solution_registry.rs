...
pub fn build_registry() -> HashMap<(&'static str, &'static str), SolutionFn> {
	...
	solution_registry.insert(("2016", "15"), crate::y_2016::day_15::solve as SolutionFn);
	solution_registry.insert(("2016", "16"), crate::y_2016::day_16::solve as SolutionFn);
	...
	solution_registry.insert(("2017", "1"), crate::y_2017::day_1::solve as SolutionFn);
	solution_registry.insert(("2017", "2"), crate::y_2017::day_2::solve as SolutionFn);
	solution_registry.insert(("2017", "4"), crate::y_2017::day_4::solve as SolutionFn);
	solution_registry.insert(("2017", "5"), crate::y_2017::day_5::solve as SolutionFn);
	solution_registry.insert(("2017", "6"), crate::y_2017::day_6::solve as SolutionFn);
	solution_registry.insert(("2017", "7"), crate::y_2017::day_7::solve as SolutionFn);
	solution_registry.insert(("2017", "8"), crate::y_2017::day_8::solve as SolutionFn);
	solution_registry.insert(("2017", "9"), crate::y_2017::day_9::solve as SolutionFn);
	solution_registry.insert(("2018", "1"), crate::y_2018::day_1::solve as SolutionFn);
	solution_registry.insert(("2018", "2"), crate::y_2018::day_2::solve as SolutionFn);
	solution_registry.insert(("2018", "5"), crate::y_2018::day_5::solve as SolutionFn);
	...
	solution_registry.insert(("2020", "1"), crate::y_2020::day_1::solve as SolutionFn);
	...
	solution_registry.insert(("2020", "6"), crate::y_2020::day_6::solve as SolutionFn);
	solution_registry.insert(("2020", "8"), crate::y_2020::day_8::solve as SolutionFn);
	solution_registry.insert(("2020", "9"), crate::y_2020::day_9::solve as SolutionFn);
	solution_registry
}
